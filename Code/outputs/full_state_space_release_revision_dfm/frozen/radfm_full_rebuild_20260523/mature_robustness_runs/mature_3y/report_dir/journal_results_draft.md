...
Generated UTC: `2026-05-23T12:25:00+00:00`

Source output directory: `<PROJECT_ROOT>/outputs/full_state_space_release_revision_dfm/exact_pseudo_backtest_mature_3y_max_iter50`

Report package directory: `<PROJECT_ROOT>/outputs/full_state_space_release_revision_dfm/exact_pseudo_backtest_mature_3y_max_iter50_report_package`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| point | joint_indicator_revision_dfm_full_kalman_em | exact | pre_advance | A | 0.900 | 33.600 | 0.000 | 3.775 |
| point | revision_dfm_kalman_em | exact | pre_advance | A | 1.000 | 26.825 | 0.000 | 3.525 |
| point | joint_indicator_revision_dfm_full_kalman_em | exact | pre_second | S | 0.911 | 34.342 | 0.000 | 0.643 |
| point | revision_dfm_kalman_em | exact | pre_second | S | 1.000 | 27.266 | 0.000 | 0.666 |
| point | joint_indicator_revision_dfm_full_kalman_em | exact | pre_third | T | 0.938 | 33.825 | 0.000 | 0.372 |
| point | revision_dfm_kalman_em | exact | pre_third | T | 1.000 | 26.363 | 0.000 | 0.373 |
| point | joint_indicator_revision_dfm_full_kalman_em | pseudo | pre_advance | A | 0.900 | 33.700 | 0.000 | 3.775 |
| point | revision_dfm_kalman_em | pseudo | pre_advance | A | 1.000 | 26.837 | 0.000 | 3.513 |
| point | joint_indicator_revision_dfm_full_kalman_em | pseudo | pre_second | S | 0.911 | 34.177 | 0.000 | 0.643 |
| point | revision_dfm_kalman_em | pseudo | pre_second | S | 1.000 | 27.266 | 0.000 | 0.666 |
| point | joint_indicator_revision_dfm_full_kalman_em | pseudo | pre_third | T | 0.925 | 34.112 | 0.000 | 0.372 |
...
| exact | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 1.411 | 1.081 | 0.389 | 0.000 | 74 |
...
| pseudo | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 1.411 | 1.081 | 0.389 | 0.000 | 74 |
...
| indicator_revision_only_dfm_kalman_em | pre_advance | A | 3.842 | 3.841 | 0.000 |
...
| joint_indicator_revision_dfm_full_kalman_em | pre_advance | A | 3.775 | 3.775 | 0.001 |
| joint_indicator_revision_dfm_full_kalman_em | pre_second | S | 0.643 | 0.643 | 0.001 |
...
| monthly_mixed_frequency_kalman_em | pre_advance | A | 4.654 | 4.655 | -0.000 |
| monthly_mixed_frequency_kalman_em | pre_second | S | 0.613 | 0.613 | 0.000 |
| monthly_mixed_frequency_kalman_em | pre_third | T | 0.373 | 0.372 | 0.001 |
...
| indicator_revision_only_dfm_kalman_em | pre_third | DELTA_MT | 1.411 | 1.411 | 0.000 |
...
| full_sample | exact | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 1.411 | 74 |
...
| full_sample | pseudo | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 1.411 | 74 |
...
| exclude_pandemic | exact | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 1.293 | 72 |
...
| exclude_pandemic | pseudo | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 1.293 | 72 |
...
| gfc_and_recovery | pseudo | pre_advance | DELTA_SA | monthly_mixed_frequency_kalman_em | 0.683 | 28 |
...
| post_pandemic | exact | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 0.731 | 10 |
...
| post_pandemic | pseudo | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 0.731 | 10 |
